            ...
            <main className="main-content">
                <header style={{ marginBottom: '3rem' }}>
                    ...
                    <p style={{ color: 'var(--text-secondary)', fontSize: '1.25rem', maxWidth: '600px', fontWeight: 600 }}>
                        Compete in hackathons, quizzes, and hiring challenges from top universities and global companies.
                    </p>
                </header>
                    ...
                    <>
                        ...
                        {!filtered.length && (
                            <div className="card-panel" style={{ padding: "1.5rem" }}>
                                <strong>No opportunities match this filter right now.</strong>
                            </div>
                        )}
                    </>
                )}
