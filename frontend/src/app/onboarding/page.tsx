...
// Kept identical in spirit to the profile page's set, deliberately.
//
// This copy carried domain, course, current_job_role, preferred_roles, skills
// and interests long after they were removed from the profile page, so stored
// "ENGINEERING" went on failing to match the option "Engineering" and the
// dropdowns broke silently. Prose fields shouted back as the user typed. Names
// only; if one of these two sets changes, change both.
